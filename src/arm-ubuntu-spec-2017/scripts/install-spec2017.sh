...
mkdir /home/gem5/mnt
echo "12345" | sudo mount -o loop -t iso9660 /home/gem5/cpu2017-1.1.0.iso /home/gem5/mnt
mkdir /home/gem5/spec2017
echo "y" | /home/gem5/mnt/install.sh -d /home/gem5/spec2017
...
cp /home/gem5/spec2017/config/Example-gcc-linux-aarch64.cfg /home/gem5/spec2017/config/myconfig.arm.cfg
...
sed -i "s/-march=native//g" /home/gem5/spec2017/config/myconfig.arm.cfg
...
sed -i "s/command_add_redirect = 1/sysinfo_program =\ncommand_add_redirect = 1/g" /home/gem5/spec2017/config/myconfig.arm.cfg
